...
class SpecManager:
    ...
    async def _merge_api_spec(self, merged_spec: Dict[str, Any], api_name: str, spec: Dict[str, Any]) -> None:
    ...
    async def _apply_overlay(self, spec: Dict[str, Any], overlay: Dict[str, Any]) -> Dict[str, Any]:
