...
from equinix_mcp_server.main import EquinixMCPServer, AuthenticatedClient
...
class TestAuthenticatedClient:
    ...
    def test_get_service_from_url(self):
        ...
        assert client._get_service_from_url("https://api.equinix.com/metal/v1/projects") == "metal"
        assert client._get_service_from_url("https://api.equinix.com/fabric/v4/connections") == "fabric"
        assert client._get_service_from_url("https://api.equinix.com/network-edge/api/v1/devices") == "network-edge"
        assert client._get_service_from_url("https://api.equinix.com/billing/v1/invoices") == "billing"
        assert client._get_service_from_url("https://api.equinix.com/other/v1/something") == "unknown"
...
class TestEquinixMCPServer:
    ...
    async def test_server_initialization_with_fastmcp(self):
        ...
        with patch('equinix_mcp_server.main.Config.load') as mock_load, \
             patch('equinix_mcp_server.main.SpecManager') as mock_spec_mgr, \
             patch('equinix_mcp_server.main.AuthManager') as mock_auth_mgr, \
             patch('equinix_mcp_server.main.DocsManager') as mock_docs_mgr, \
             patch('equinix_mcp_server.main.FastMCP') as mock_fastmcp_class:
            ...
            mock_spec_instance.get_merged_spec = AsyncMock(return_value={
                'openapi': '3.0.3',
